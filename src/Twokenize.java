...
public class Twokenize {
    ...
    static String Hashtag = "#[\\p{IsAlphabetic}+0-9_]+";  //optional: lookbehind for \b
    ...
    public static void main(String[] args) throws IOException {
        BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("tweets.txt"),"UTF-8"));
        PrintStream output = new PrintStream(new FileOutputStream("hun_tweets_2015_10_2016_02.tokenized"), true, "UTF-8");
    	String line;
